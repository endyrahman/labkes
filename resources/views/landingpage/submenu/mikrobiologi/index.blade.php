...
<section class="section">
    <div class="container">
        <div class="row align-items-center">
            @php
                $pglayananklinik = App\Models\Landingpage\Layanankami\LayanankamiTbl::getDataLayananKami(3);
            @endphp
        ...
        <div class="row">
            <div class="col-lg-12 mt-sm-0 pt-sm-0">
                ...
                <div class="row" id="listparameterklinik">
                    @include('landingpage.submenu.mikrobiologi.list')
                </div>
...
<script type="text/javascript">
    ...
    function paginationLpPemeriksaan(page, pencarian) {
        $.ajax({
            url:"/labmikrobiologi/paginationpemeriksaan?pagepemeriksaan="+page+"&pencarian="+pencarian+"&laboratorium=3",
