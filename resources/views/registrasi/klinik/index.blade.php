        ...
        <div class="table-responsive">
            <table class="table table-bordered table-hover mb-4">
                ...
                <tbody id="bodyGridKlinik">
                    @include('registrasi.klinik.gridklinik')
                </tbody>
            </table>
            <input type="hidden" name="hidden_page_gridklinik" id="hidden_page_gridklinik" value="1"/>
        </div>
    </div>
</div>
        ...
        <div class="modal-content">
            ...
            <form action="{{ url('/registrasi/delete') }}" method="post">
                ...
                <div class="modal-body">
                    ...
                    <input type="hidden" name="lab_id" id="lab_id" value="1" class="form-control"></input>
...
<script type="text/javascript">
    ...
    function paginationGrid(page, combocari, pencarian) {
        $('#hidden_page_gridklinik').val(page);
