        ...
        <div class="card-body">
            ...
            <div class="text-center">
                <div class="btn-group" role="group" aria-label="Basic example">
                    ...
                    <button type="button" class="btn btn-sm btn-info" data-toggle="modal" data-target="#mdlDetailPemeriksaanMikrobiologi" onclick="getDetailPaketPemeriksaan({{$val->paket_pemeriksaan_id}},'{{$val->arr_parameter_id}}',{{$val->lab_pemeriksaan_id}})" style="padding:5px 8px 5px 8px;">
                            Detail
                        </button>
                </div>
            </div>
