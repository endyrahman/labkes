...
<div class="col-xl-12 col-lg-12 col-md-12 col-sm-12 col-12 layout-spacing">
    ...
    <div class="widget-heading">
        <div class="">
            <h5 class=""> Daftar Registrasi Online Lab Kimia</h5>
        </div>
        <a href="/registrasi/kimia/create" class="btn btn-success"><svg xmlns="http://www.w3.org/2000/svg" width="24" height="24" viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="2" stroke-linecap="round" stroke-linejoin="round" class="feather feather-plus-circle"><circle cx="12" cy="12" r="10"></circle><line x1="12" y1="8" x2="12" y2="16"></line><line x1="8" y1="12" x2="16" y2="12"></line></svg> Registrasi</a>
    </div>
    <div class="widget-content widget-content-area br-12 pb-3 pl-3 pr-3">
        ...
        <div class="table-responsive">
            <table class="table table-bordered table-hover mb-4">
                ...
                <tbody id="bodyGridKimia">
                    @include('registrasi.kimia.gridkimia')
                </tbody>
            </table>
...
<script type="text/javascript">
    ...
    function paginationGrid(page, combocari, pencarian) {
        $('#hidden_page_gridkimia').val(page);
        ...
        $.ajax({
            url:"/registrasi/kimia/paginationgridpemeriksaan?pagegridpemeriksaan="+page+"&combocari="+combocari+"&pencarian="+pencarian+"&lab_id=2",
            success:function(datas)
            {
                $('#bodyGridKimia').html('');
                $('#bodyGridKimia').html(datas);
            }
        });
    }
