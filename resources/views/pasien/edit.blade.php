                ...
                <div class="col-lg-12 mx-auto">
                    <div class="row">
                        <div class="col-xl-12 col-lg-12 col-md-12 mt-md-0">
                            <form method="POST" action="/pasien/{{$data->id}}" id="pasien-form">
                                {{ csrf_field() }}
                                @method('PUT')
                                <div class="row">
                                    <div class="col-sm-6">
                                        <label for="nama_pasien">Nama Pasien</label>
                                        <input id="nama_pasien" name="nama_pasien" class="form-control" value="{{ $data->nama_pasien }}" required>
                                    </div>
                                    <div class="col-sm-6">
                                        <label for="nik">NIK</label>
                                        <input id="nik" name="nik" class="form-control" value="{{ $data->nik }}" required>
                                    </div>
                                </div>
                                <div class="row mt-2">
                                    <div class="col-sm-4">
                                        <label for="tempat_lahir">Tempat Lahir</label>
                                        <input id="tempat_lahir" name="tempat_lahir" class="form-control" value="{{ $data->tempat_lahir }}" required>
                                    </div>
                                    <div class="col-sm-4">
