...
<div class="col-xl-12 col-lg-12 col-md-12 col-sm-12 col-12 layout-spacing">
    ...
    <div class="widget-heading">
        <div class="">
            <h5 class=""> Edit Jenis Pemeriksaan</h5>
        </div>
    </div>
                ...
                <div class="col-lg-12 mx-auto">
                    <div class="row">
                        <div class="col-xl-12 col-lg-12 col-md-12 mt-md-0 mt-4">
                            <form method="POST" action="{{ url('/master/jenispemeriksaan/'.$data->id) }}">
                                {{csrf_field()}}
                                {{ method_field('PATCH') }}
                                <input type="text" name="jenis_pemeriksaan_id" id="jenis_pemeriksaan_id" value="{{ $data->id }}" class="form-control" readonly>
                                <div class="row">
                                    <div class="col-sm-6">
                                        <div class="form-group">
                                            ...
                                            <select class="form-control" id="lab_pemeriksaan_id" name="lab_pemeriksaan_id" required>
                                                ...
                                                @foreach($lab as $val)
                                                    <option value="{{ $val->id }}" {{ $val->id == $data->lab_pemeriksaan_id ? 'selected="selected"' : ''}} >{{ $val->nama_jenis_lab }}</option>
                                                @endforeach
                                            </select>
                                        </div>
                                    </div>
                                ...
                                <div class="row">
                                    <div class="col-sm-6">
                                        <div class="form-group">
                                            <label for="tgl_pendaftaran">Nama Pemeriksaan <span style="color:red;">*</span></label>
                                            <input id="nama_pemeriksaan" name="nama_pemeriksaan" class="form-control" type="text" placeholder="Nama Pemeriksaan" value="{{ $data->nama_pemeriksaan }}" required>
                                        </div>
                                    </div>
                                </div>
                                <div class="row">
                                    <div class="col-sm-6" id="data_parameter_pemeriksaan">

                                    </div>
                                    <div class="col-sm-6" id="daftar_parameter_pemeriksaan">
                                        <div class="form-group">
