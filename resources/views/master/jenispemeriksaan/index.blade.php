        ...
        <table id="dt-mstjenispemeriksaan" class="table dt-table-hover" style="width:100%">
            <thead>
                <tr>
                    ...
                    <th style="width:120px;">Parameter Pemeriksaan</th>
                    <th>Status</th>
            ...
            <tbody>
                ...
                <tr>
                    ...
                    <td style="width:120px;">
                        {{ $val->arr_nama_parameter }}<br/>
                        {{ $val->arr_nama_parameter2 }}
                    </td>
                    <td>
                        @if ($val->status == 1)
