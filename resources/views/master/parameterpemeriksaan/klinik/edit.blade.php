...
<div class="col-xl-12 col-lg-12 col-md-12 col-sm-12 col-12 layout-spacing">
    ...
    <div class="widget-heading">
        <div class="">
            <h5 class=""> Edit Master Data Parameter Pemeriksaaan Klinik</h5>
        </div>
    </div>
                ...
                <div class="col-lg-12 mx-auto">
                    <div class="row">
                        <div class="col-xl-12 col-lg-12 col-md-12 mt-md-0 mt-4">
                            <form method="POST" action="{{ url('/master/parameterpemeriksaan/update/1') }}">
                            <input type="hidden" name="_token" value="{{ csrf_token() }}" />
                                <input id="jenis_lab_id" name="jenis_lab_id" class="form-control" value="2" type="hidden">
                                <input id="parameter_id" name="parameter_id" class="form-control" value="{{ $data->id }}" type="hidden">
                                <div class="row">
                                    <div class="col-sm-6">
                                        <div class="form-group">
                                            <label for="nama_parameter">Nama Parameter</label>
                                            <input type="text" name="nama_parameter" id="nama_parameter" value="{{ $data->nama_parameter }}" class="form-control" required>
                                        </div>
                                    </div>
                                </div>
                                <div class="row">
                                    <div class="col-sm-6">
                                        <div class="form-group">
                                            ...
                                            <input type="text" name="harga" id="harga" value="{{ number_format($data->harga, 0, ',', '.') }}" class="form-control" required style="text-align: right;" onchange="this.value = formatCurrency(this.value);" onblur="this.value = formatCurrency(this.value);" onkeyup="this.value = formatCurrency(this.value);">
                                        </div>
                                    </div>
                                </div>
                                <div class="row">
