...
<script type="text/javascript">
    function getDetailPaketPemeriksaan(detail_paket_pemeriksaan) {
        ...
        $.ajax({
            type:'POST',
            url: '{{ url("/master/getdetailmstpaketpemeriksaan") }}',
    ...
    function paginationGrid(page, combocari, pencarian) {
        ...
        $.ajax({
            url:"{{ url('/spr/master/paketpemeriksaan/paginationmstpaketpemeriksaan') }}",
            type: 'GET',
            data: {
                pagemstgridpaketpemeriksaan: page,
                combocari: combocari,
                pencarian: pencarian
            },
