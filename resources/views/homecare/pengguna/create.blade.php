            ...
            <div class="row">
                <div class="col-lg-12 mx-auto">
                    <div class="row">
                        ...
                        <form method="POST" action="{{ url('/homecare/pengguna/storehomecare') }}">
                            <input type="hidden" name="_token" value="{{ csrf_token() }}" />
                                <div class="row">
                                    <div class="col-sm-6">
                                        <div class="form-group">
                                            <label for="jenis_homecare_id">Pilih Pelayanan Home Care <span style="color:#e7515a;">*</span></label>
                                ...
                                <div class="row mb-4">
                                    <div class="col-sm-4">
                                        <div class="form-group">
                                            <label for="nama_lengkap">Nama Lengkap <span style="color:#e7515a;">*</span></label>
                                            <input id="nama_lengkap" name="nama_lengkap" class="form-control" type="text" required>
                                        </div>
                                    </div>
                                    <div class="col-sm-3">
                                        <div class="form-group">
                                            <label for="no_hp">No. HP <span style="color:#e7515a;">*</span></label>
                                            <input id="no_hp" name="no_hp" class="form-control" type="number" required>
                                        </div>
                                    </div>
                                    <div class="col-sm-5">
                                        <div class="form-group">
                                ...
                                <div class="row mb-4">
                                    <div class="col-sm-12">
                                        <div class="form-group">
                                            ...
                                            <textarea class="form-control basic" id="catatan_homecare" name="catatan_homecare" rows='3' maxlength="1000" required></textarea>
                                        </div>
                                    </div>
                                </div>
