@php
    $i = ($halaman->currentpage()-1)* $halaman->perpage() + 1;
    $totalrow = $halaman->total();
@endphp
...
<tr>
    <td colspan="10">{{ $halaman->appends(['combocariclosing' => Request::get('combocariclosing'), 'pencarianclosing' => Request::get('pencarianclosing')])->render() }}</td>
</tr>
