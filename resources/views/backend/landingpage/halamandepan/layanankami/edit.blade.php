                ...
                <div class="col-lg-12 mx-auto">
                    <div class="row">
                        <div class="col-xl-12 col-lg-12 col-md-12 mt-md-0">
                            <form method="POST" action="{{ url('/spr/landingpage/layanankami/'.$layanan->id) }}" enctype="multipart/form-data">
                                {{csrf_field()}}
                                {{ method_field('PATCH') }}
                                <div class="row">
                                    <div class="col-sm-7">
                                        <div class="form-group">
                                            ...
                                            <input id="nama_layanan" name="nama_layanan" class="form-control" type="text" value="{{$layanan->nama_layanan}}" required>
                                        </div>
                                    </div>
                                </div>
                                <div class="row">
                                    <div class="col-sm-12">
                                        <div class="form-group">
                                            ...
                                            <textarea class="form-control" rows="10" id="keterangan" name="keterangan" required>{{$layanan->keterangan}}</textarea>
                                        </div>
                                    </div>
                                </div>
                                <div class="row">
                                    <div class="col-sm-6">
                                        <div class="custom-file-container" data-upload-id="fotoLayanan">
                                            ...
                                            <label class="custom-file-container__custom-file" >
                                                <input type="file" class="custom-file-container__custom-file__custom-file-input" accept="image/*" id="foto_layanan" name="foto_layanan">
