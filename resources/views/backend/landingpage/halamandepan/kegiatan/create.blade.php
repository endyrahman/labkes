                ...
                <div class="col-lg-12 mx-auto">
                    <div class="row">
                        <div class="col-xl-12 col-lg-12 col-md-12 mt-md-0">
                            <form method="POST" action="{{ url('/spr/landingpage/kegiatan') }}" enctype="multipart/form-data">
                            <input type="hidden" name="_token" value="{{ csrf_token() }}" />
                                <div class="row">
                                    <div class="col-sm-7">
                                        <div class="form-group">
                                            <label for="nama_kegiatan">Nama Kegiatan</label>
                                            <input id="nama_kegiatan" name="nama_kegiatan" class="form-control" type="text"  required>
                                        </div>
                                    </div>
                                    <div class="col-sm-3">
                                        <div class="form-group">
                                    ...
                                    <div class="col-sm-2">
                                        <div class="form-group">
                                            ...
                                            <input id="tgl_kegiatan" name="tgl_kegiatan" value="{{ date('d-m-Y') }}" class="form-control flatpickr flatpickr-input active" type="text" required>
                                        </div>
                                    </div>
                                </div>
                                <div class="row">
                                    ...
                                    <div class="col-sm-6">
                                        <div class="custom-file-container" data-upload-id="fotoKegiatan">
                                            ...
                                            <label class="custom-file-container__custom-file" >
                                                <input type="file" class="custom-file-container__custom-file__custom-file-input" accept="image/*" id="foto_kegiatan" name="foto_kegiatan" required>
