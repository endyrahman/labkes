                ...
                <div class="col-lg-12 mx-auto">
                    <div class="row">
                        <div class="col-xl-12 col-lg-12 col-md-12 mt-md-0">
                            <form method="POST" action="{{ url('/spr/landingpage/slide/'.$slide->id) }}" enctype="multipart/form-data">
                                {{ csrf_field() }}
                                {{ method_field('PATCH') }}
                                <div class="row">
                                    <div class="col-sm-6">
                                        <div class="form-group">
                                            ...
                                            <input type="text" class="form-control" name="nama" id="nama" value="{{ $slide->nama }}" required>
                                        </div>
                                    </div>
                                </div>
                                <div class="row">
                                    <div class="col-sm-6">
                                        <div class="custom-file-container" data-upload-id="fotoSlide">
                                            ...
                                            <label class="custom-file-container__custom-file" >
                                                <input type="file" class="custom-file-container__custom-file__custom-file-input" accept="image/*" id="foto_slide" name="foto_slide">
                                ...
                                <div class="row">
                                    <div class="col-sm-6">
                                        <div class="form-group">
                                            <label for="statusSlide">Status <span id="nameStatus"></span></label>
                                            <div class="form-group mb-2">
                                                <label class="switch s-icons s-outline s-outline-success">
                                                    <input type="checkbox" id="statusSlide" @if ($slide->status == 1) checked @endif>
...
<script>
    var upFotoSlide = new FileUploadWithPreview('fotoSlide');

    $('#statusSlide').on('change', function(){
