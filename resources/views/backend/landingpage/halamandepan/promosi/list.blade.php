    ...
    <td class="text-center">
        <div class="d-flex">
            <div class="usr-img-frame mr-2">
                <img class="img-fluid" src="/storage/foto_promosi/{{ $val->nama_file }}">
            </div>
        </div>
    </td>
    <td class="text-center">
